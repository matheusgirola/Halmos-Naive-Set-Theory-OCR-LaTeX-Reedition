...
The \textit{ordered pair}\index{ordered pair} of $a$ and $b$, with \textit{first coordinate a}\index{coordinate}\index{first coordinate} and \textit{second coordinate b}\index{second coordinate}, is the set $(a, b)$ defined by 
...
These sets are called the \textit{projections}\index{projection} of $R$ onto the first and second coordinates respectively.
