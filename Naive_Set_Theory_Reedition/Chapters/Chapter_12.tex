...
Property \eqref{eq12.3} is known as the \textbf{principle of mathematical induction.}\index{induction} We shall now add to this list of properties of $\omega$ two others: 
