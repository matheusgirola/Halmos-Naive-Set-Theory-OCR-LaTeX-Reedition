...
If $A$ and $B$ are sets, the \textit{symmetric difference}\index{symmetric difference} (or \textit{Boolean sum}\index{Boolean sum}) of $A$ and $B$ is the set $A + B$ defined by 
