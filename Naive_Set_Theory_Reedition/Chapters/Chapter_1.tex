...
The principal concept of set theory, the one that in completely axiomatic studies is the principal primitive (undefined) concept, is that of \textit{belonging}\index{belonging}. If $x$ belongs to $A$ ($x$ is an element of $A$, $x$ is \textit{contained}\index{contain} in $A$), we shall write 
